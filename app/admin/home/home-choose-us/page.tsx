...
import {
  ...
  listWhyChooseUsApi,
  WhyChooseUsSection,
} from "@/app/api/admin/home/homeChooseus";

export default function WhyChooseUsPage() {
  const [data, setData] = useState<WhyChooseUsSection[]>([]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Why Choose Us</h1>

          <p className="text-gray-500">Manage Why Choose Us section.</p>
        </div>

        <Link
          href="/admin/home/home-choose-us/create"
                ...
                >
                  ...
                  <td className="p-4">
                    <span className="inline-flex items-center gap-1 text-sm text-gray-600">
                      <Layers size={14} />
                      {item.features?.length ?? 0} feature
                      {item.features?.length !== 1 ? "s" : ""}
                    </span>
                  </td>
                  ...
                  <td className="p-4">
                    <div className="flex gap-3">
                      <Link
                        href={`/admin/home/home-choose-us/edit/${item._id}`}
