...
import {
  deleteSecurityServices,
  listSecurityServicesApi,
  SecurityServicesSection,
} from "@/app/api/admin/home/homeservice";

export default function SecurityServicesPage() {
  const [data, setData] = useState<SecurityServicesSection[]>([]);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await deleteSecurityServices(id);
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">
            Manage Home Security Services section.
          </p>
        </div>

        <Link
          href="/admin/home/home-service/create"
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 border-b">
              ...
              <th className="p-4 font-semibold text-gray-700">Services</th>
                ...
                >
                  ...
                  <td className="p-4">
                    <span className="inline-flex items-center gap-1 text-sm text-gray-600">
                      <ShieldCheck size={14} />
                      {item.services?.length ?? 0} service
                  ...
                  <td className="p-4">
                    <div className="flex gap-3">
                      <Link
                        href={`/admin/home/home-service/edit/${item._id}`}
