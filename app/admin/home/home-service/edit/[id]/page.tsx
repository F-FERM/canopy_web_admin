...
export default function EditSecurityServicesPage() {
  ...
  const [initialData, setInitialData] =
    useState<Partial<SecurityServicesSection> | null>(null);
    ...
    const load = async () => {
      try {
        ...
        const found = all.find(
          (item: SecurityServicesSection) => item._id === id,
        );
  ...
  const handleSubmit = async (data: any) => {
    try {
      ...
      alert("Failed to update Security Services");
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500">Update Security Services section.</p>
        </div>
      </div>
