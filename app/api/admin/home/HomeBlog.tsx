...
export const listBlogSectionApi = async (data: {
  ...
  try {
    ...
    const response = await axiosInstance.get<BlogSection[]>(
...
export const createBlogSection = async (data: Partial<BlogSection>) => {
  try {
...
export const deleteBlogSection = async (id: string) => {
  try {
