...
export const listCareerOpeningsApi = async (data: {
  ...
  try {
    ...
    const response = await axiosInstance.get<CareerOpeningsSection[]>(
...
export const createCareerOpenings = async (
...
export const updateCareerOpenings = async (
  data: Partial<CareerOpeningsSection> & {
    _id: string;
  },
) => {
...
export const deleteCareerOpenings = async (id: string) => {
  try {
