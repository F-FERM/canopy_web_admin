...
export const listUpcomingEventsApi = async (data: {
  ...
  try {
    ...
    const response = await axiosInstance.get<UpcomingEventsSection[]>(
...
export const createUpcomingEvents = async (
...
export const updateUpcomingEvents = async (
  data: Partial<UpcomingEventsSection> & {
    _id: string;
  },
) => {
...
export const deleteUpcomingEvents = async (id: string) => {
  try {
