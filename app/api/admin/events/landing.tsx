...
export const listEventsLandingApi = async (data: {
  ...
  try {
    ...
    const response = await axiosInstance.get<EventsLandingSection[]>(
...
export const createEventsLanding = async (
...
export const updateEventsLanding = async (
  data: Partial<EventsLandingSection> & {
    _id: string;
  },
) => {
...
export const deleteEventsLanding = async (id: string) => {
  try {
