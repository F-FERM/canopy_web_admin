...
export const listContactLandingApi = async (data: {
  search?: string;
  page?: number;
  limit?: number;
}) => {
  ...
  try {
    ...
    const response = await axiosInstance.get<ContactLandingSection[]>(
...
export const createContactLanding = async (
...
export const updateContactLanding = async (
  data: Partial<ContactLandingSection> & {
    _id: string;
  },
) => {
...
export const deleteContactLanding = async (id: string) => {
  try {
